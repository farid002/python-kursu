...
eded = int(input("100-ə qədər hər hansı 1 tam ədəd daxil edin \n "))
...
if eded>100:
    print("Yenidən kiçik bir sayı ilə davam edin!")
else:
    print(f"Daxil edilən ədəd dəyəri: {eded}")
    print(f"Həmin dəyərdən kiçik sadə ədədlərin sayı: {sade_eded_sayi}")
